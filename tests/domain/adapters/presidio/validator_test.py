...
class TestPresidioValidatorInitialization:
    ...
    def test_init_creates_analyzer_engine(self, mock_logger: LoggerContract) -> None:
        """Should initialize with analyzer engine from factory."""
        # Arrange
        mock_analyzer = Mock()

        # Act
        with patch.object(
            PresidioEngineFactory,
            "get_analyzer_engine",
        ...
        assert presidio_validator.analyzer_engine == mock_analyzer
